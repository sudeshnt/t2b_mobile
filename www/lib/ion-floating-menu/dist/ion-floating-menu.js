...
(function () {
    ...
    function ionFloatingButton() {
        return {
            ...
            scope: {
                ...
                textClass: '@?',
                bottom: '@?'},
            template: '<ul ng-click="click()" id="floating-button" ng-class="{\'center\': isCentered}" ng-style="{\'bottom\' : \'{{bottom}}\',\'left\' : \'{{buttonLeft}}\' }">' +
    ...
    function ionFloatingButtonCtrl($scope) {
        ...
        $scope.icon = $scope.icon || 'ion-android-cart';
    ...
    function ionFloatingMenuCtrl($scope, $rootScope, $ionicBackdropIon) {
        ...
        var menuIcon = $scope.menuIcon || 'ion-android-cart';
